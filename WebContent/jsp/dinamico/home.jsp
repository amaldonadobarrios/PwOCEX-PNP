<div class="row">
    ...
    <div class="col s12 m12">
      <div class="card deep-orange lighten-4">
        <div class="card-content blue-text text-darken-2">
          <p class="center-align"><strong>La información proporcionada por el Sistema OCEX- PNP, es de interes único y exclusivo para el personal policial, su contenido debe ser conocido exclusivamente por el usuario autorizado.
          </strong></p>
         </div>
      </div>
    </div>
